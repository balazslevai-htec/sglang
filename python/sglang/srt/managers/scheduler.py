...
SGLANG_TORCH_PROFILER_STEPS_NUM=int(os.getenv("SGLANG_TORCH_PROFILER_STEPS_NUM", 200))
SGLANG_TORCH_PROFILER_START_OFFSET=int(os.getenv("SGLANG_TORCH_PROFILER_START_OFFSET", 200))
SGLANG_TORCH_PROFILER_PROFILE_ID=os.getenv("SGLANG_TORCH_PROFILER_PROFILE_ID", "torch_prof")
SGLANG_TORCH_PROFILER_WITH_STACK=bool(int(os.getenv("SGLANG_TORCH_PROFILER_WITH_STACK", 1)))
SGLANG_TORCH_PROFILER_RECORD_SHAPE=bool(int(os.getenv("SGLANG_TORCH_PROFILER_START_OFFSET", 0)))
SGLANG_TORCH_PROFILER_STAGE_PROFILE=bool(int(os.getenv("SGLANG_TORCH_PROFILER_STAGE_PROFILE", 0)))
